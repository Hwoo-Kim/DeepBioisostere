...
PERSISTENT_OUTPUT_TAR_DIR_BASE="/home/mseok/work/DL/DeepBioisostere/Resubmission_DeepBioisostere/exps/fig5_new_case_study/20250607_final/docking_gpu_results"
...
if command -v conda &>/dev/null; then
    ...
    if [ $? -ne 0 ]; then echo "SLURM ERROR: Failed to activate conda environment 'Bioiso'."; exit 1; fi
else
